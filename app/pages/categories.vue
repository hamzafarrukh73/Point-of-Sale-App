...
const orderingOptions = categoriesStore.orderingOptions ? Object.keys(categoriesStore.orderingOptions) : [];
                                ...
                                <UModal title="Delete Category">
                                    ...
                                    <template #body>
                                        <UForm id="delete-category-form" @submit="deleteItem(category.id)">
                                            <h6>Are you sure you want to delete <strong>"{{ category.name }}"</strong>?</h6>
                                        </UForm>
                                    </template>
