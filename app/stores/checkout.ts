...
export const useCheckoutStore = defineStore('checkoutStore', {
    ...
    getters: {
        ...
        totalPrice: (state) => {
            return state.sale.items.reduce((total, item) => total + (item.price_at_sale * item.quantity), 0).toFixed(2)
        },
        itemsCount: (state) => {
    ...
    actions: {
        ...
        async createItem() {
            ...
            this.sale.discount_amount = 0.00;
            this.sale.tax_amount = 0.00;
            this.sale.total_amount = parseFloat(this.totalPrice) - this.sale.discount_amount + this.sale.tax_amount;
